...
SHORT = [("New York Times", "NYT"), ("University of Massachusetts Lowell", "UMass Lowell"), ("Washington Post", "WaPo"),
...
def race_average(polls, state, a, b, district=None, labels=("D", "R")):
    ...
    flagged = sum(w for p, _, w in use if p.get("internal") or p.get("partisan")) / W
